...
namespace sgtpenguin\geocode\fields;

use sgtpenguin\geocode\Geocode;
use sgtpenguin\geocode\assetbundles\addressfield\AddressFieldAsset;
...
class Address extends Field
{
    ...
    {
        return Craft::t('geocode', 'Address');
    }
    ...
    {
        if (is_object($value) || is_null($value) || is_array($value)) {
            return $value;
        }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'geocode/_components/fields/Address_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        $googleApiKey = \sgtpenguin\geocode\Geocode::getInstance()->settings->googleApiKey;  
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').GeocodeAddress(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'geocode/_components/fields/Address_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
