...
use sgtpenguin\specialrelations\assetbundles\childrenfield\ChildrenFieldAsset;
...
class Children extends Field
{
  ...
  protected $elementType = 'Entry';
    ...
    {
        return Craft::t('special-relations', 'Children');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'special-relations/_components/fields/Children_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(ChildrenFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').SpecialRelationsChildren(" . $jsonVars . ");");

        $elements   = array_filter([$this->getElement($value)]);
        
        // $variables = $this->getInputTemplateVariables($name, $criteria);

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'special-relations/_components/fields/Children_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
