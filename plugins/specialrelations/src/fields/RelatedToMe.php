...
namespace sgtpenguin\specialrelations\fields;

use sgtpenguin\specialrelations\SpecialRelations;
use sgtpenguin\specialrelations\assetbundles\relatedtomefield\RelatedToMeFieldAsset;
 ...
 * @since     1.0.0
 */
class RelatedToMe extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('special-relations', 'RelatedToMe');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'special-relations/_components/fields/RelatedToMe_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(RelatedToMeFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').SpecialRelationsRelatedToMe(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'special-relations/_components/fields/RelatedToMe_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
